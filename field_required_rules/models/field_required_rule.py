...
class FieldRequiredRule(models.Model):
    _name = 'field.required.rule'
    _description = 'Field Required Rule'
    ...
    line_ids = fields.One2many(
        'field.required.rule.line', 'rule_id',
        string='Field Lines', copy=True,
        help='One line per required field, with its own trigger field, '
