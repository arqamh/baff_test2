...
class PettyCashReimbursementSummaryWizard(models.TransientModel):
    """summary report generate Wizard"""
    _name = 'reimbursement.summery.report.generate.wizard'
    _description = 'Summary report generate wizard'
