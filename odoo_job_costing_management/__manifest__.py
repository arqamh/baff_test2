...

{
    ...
    'depends': [
        ...
        'crm',
        'mrp',
        'centrics_user_approve',
        # 'fine_finish_inventory_modifications',
        'sale_management',
        'baff_sales_modifications',
        'account_accountant',
        'hr',
        'planning',
        'centrics_sales_separate_process',
    ],
...
""",
    ...
    'data': [
        ...
        'wizard/add_components_wizard_views.xml',
        'wizard/change_supplier_wizard_views.xml',
        'wizard/job_costing_approvers_wizard_views.xml',
        'views/job_mrp_bom_views.xml',
        ...
        'views/request_purchase_requisitions.xml',
