...
class PurchaseOrderLine(models.Model):
    ...
    purchase_req_id = fields.Many2one('material.purchase.requisition', string='Requisition')
    requested_user = fields.Many2one(related="job_cost_line_id.prepared_by")
            ...
            for line in order.order_line:
                ...
                if not line.job_cost_line_id:
                    if cost_id:
                        ...
                        vals = {'date': date, 'product_id': product_id, 'description': description,
                                'job_type': job_type, 'product_qty': qty, 'cost_price': price, 'hours': hours}
